    ...
    const startRecording = async () => {
      ...
      mediaRecorderRef.current.onstop = async () => {
        ...
        try {
          ...
          if (intent === "GET_EXPENSES") navigate("/main/expenses");
          else if (intent === "ADD_EXPENSE") navigate("/main/manual", { state: { voiceData: data } });
          else if (intent === "ADD_MULTIPLE") navigate("/main/multiple", { state: { voiceData: data } });
          else alert("Command not recognized. Speak clearly.");
